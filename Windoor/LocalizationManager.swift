...
class LocalizationManager {
    ...
    private let translations: [AppLanguage: [String: String]] = [
        .japanese: [
            ...
            "accessibilityPermissionTitle": "アクセシビリティを許可",
            "accessibilityPermissionMessage": "Windoorを上のアプリ一覧へドラッグして追加してください。",
            "accessibilityPermissionDragHint": "このWindoorをシステム設定へドラッグ",
            "accessibilityPermissionOpenSettings": "アクセシビリティ設定を開く",
            "accessibilityPermissionWaiting": "許可されると自動で有効になります",
        ...
        .english: [
            ...
            "anchorNearest": "Nearest Corner",
            "anchorFarthest": "Farthest Corner",
            "modifierKey": "Modifier Key",
            "click": "Click",
            "leftClickOnlyWarning": "Left click cannot be used by itself.",
            ...
            "accessibilityPermissionTitle": "Allow Accessibility",
            "accessibilityPermissionMessage": "Drag Windoor to the app list above to add it.",
            "accessibilityPermissionDragHint": "Drag this Windoor app into System Settings",
            "accessibilityPermissionOpenSettings": "Open Accessibility Settings",
            "accessibilityPermissionWaiting": "Windoor activates automatically when allowed",
        ...
        .german: [
            ...
            "anchorNearest": "Nächste Ecke",
            "anchorFarthest": "Entfernteste Ecke",
            "modifierKey": "Modifikatortaste",
            "click": "Klick",
            "leftClickOnlyWarning": "Linksklick kann nicht allein verwendet werden.",
            ...
            "accessibilityPermissionTitle": "Bedienungshilfen erlauben",
            "accessibilityPermissionMessage": "Ziehen Sie Windoor in die App-Liste oben.",
            "accessibilityPermissionDragHint": "Windoor in die Systemeinstellungen ziehen",
            "accessibilityPermissionOpenSettings": "Bedienungshilfen öffnen",
            "accessibilityPermissionWaiting": "Nach der Freigabe wird Windoor automatisch aktiv",
        ...
        .french: [
            ...
            "anchorNearest": "Coin le plus proche",
            "anchorFarthest": "Coin le plus éloigné",
            "modifierKey": "Touche modif.",
            "click": "Clic",
            "leftClickOnlyWarning": "Le clic gauche ne peut pas être utilisé seul.",
            ...
            "accessibilityPermissionTitle": "Autoriser l’accessibilité",
            "accessibilityPermissionMessage": "Faites glisser Windoor dans la liste d’apps ci-dessus.",
            "accessibilityPermissionDragHint": "Faire glisser Windoor vers Réglages Système",
            "accessibilityPermissionOpenSettings": "Ouvrir les réglages Accessibilité",
            "accessibilityPermissionWaiting": "Windoor s’active automatiquement après autorisation",
        ...
        .spanish: [
            ...
            "anchorNearest": "Esquina más cercana",
            "anchorFarthest": "Esquina más lejana",
            "modifierKey": "Tecla modificadora",
            "click": "Clic",
            "leftClickOnlyWarning": "El clic izquierdo no puede usarse solo.",
            ...
            "accessibilityPermissionTitle": "Permitir accesibilidad",
            "accessibilityPermissionMessage": "Arrastra Windoor a la lista de apps de arriba.",
            "accessibilityPermissionDragHint": "Arrastrar Windoor a Ajustes del Sistema",
            "accessibilityPermissionOpenSettings": "Abrir ajustes de accesibilidad",
            "accessibilityPermissionWaiting": "Windoor se activa automáticamente al permitirlo",
        ...
        .korean: [
            ...
            "anchorNearest": "가장 가까운 모서리",
            "anchorFarthest": "가장 먼 모서리",
            "modifierKey": "수식 키",
            "click": "클릭",
            ...
            "accessibilityPermissionTitle": "손쉬운 사용 허용",
            "accessibilityPermissionMessage": "Windoor를 위의 앱 목록으로 드래그해 추가하세요.",
            "accessibilityPermissionDragHint": "Windoor를 시스템 설정으로 드래그",
            "accessibilityPermissionOpenSettings": "손쉬운 사용 설정 열기",
            "accessibilityPermissionWaiting": "허용되면 Windoor가 자동으로 활성화됩니다",
        ...
        .chineseSimplified: [
            ...
            "modifierKey": "修饰键",
            "click": "点击",
            "leftClickOnlyWarning": "不能仅设置为左键点击。",
            "modifierOnly": "仅修饰键",
            "axisConstraint": "轴向限制",
            ...
            "accessibilityPermissionTitle": "允许辅助功能",
            "accessibilityPermissionMessage": "将 Windoor 拖到上方的应用列表中以添加。",
            "accessibilityPermissionDragHint": "将 Windoor 拖到系统设置",
            "accessibilityPermissionOpenSettings": "打开辅助功能设置",
            "accessibilityPermissionWaiting": "允许后 Windoor 会自动启用",
        ...
        .chineseTraditional: [
            ...
            "modifierKey": "修飾鍵",
            "click": "點擊",
            "leftClickOnlyWarning": "不能僅設定為左鍵點擊。",
            "modifierOnly": "僅修飾鍵",
            "axisConstraint": "軸向限制",
            ...
            "accessibilityPermissionTitle": "允許輔助使用",
            "accessibilityPermissionMessage": "將 Windoor 拖到上方的 App 列表中以加入。",
            "accessibilityPermissionDragHint": "將 Windoor 拖到系統設定",
            "accessibilityPermissionOpenSettings": "開啟輔助使用設定",
            "accessibilityPermissionWaiting": "允許後 Windoor 會自動啟用",
        ...
        .portugueseBrazil: [
            ...
            "anchorNearest": "Canto mais próximo",
            "anchorFarthest": "Canto mais distante",
            "modifierKey": "Tecla Modificadora",
            "click": "Clique",
            "leftClickOnlyWarning": "O clique esquerdo não pode ser usado sozinho.",
            ...
            "accessibilityPermissionTitle": "Permitir Acessibilidade",
            "accessibilityPermissionMessage": "Arraste o Windoor para a lista de apps acima.",
            "accessibilityPermissionDragHint": "Arrastar Windoor para Ajustes do Sistema",
            "accessibilityPermissionOpenSettings": "Abrir ajustes de Acessibilidade",
            "accessibilityPermissionWaiting": "O Windoor é ativado automaticamente após a permissão",
        ...
        .russian: [
            ...
            "anchorTopLeft": "Слева сверху",
            "anchorTopRight": "Справа сверху",
            "anchorBottomLeft": "Слева снизу",
            "anchorBottomRight": "Справа снизу",
            "anchorNearest": "Ближайший угол",
            "anchorFarthest": "Самый дальний угол",
            "modifierKey": "Модификатор",
            "click": "Клик",
            "leftClickOnlyWarning": "Левый клик нельзя использовать отдельно.",
            ...
            "accessibilityPermissionTitle": "Разрешить универсальный доступ",
            "accessibilityPermissionMessage": "Перетащите Windoor в список приложений выше.",
            "accessibilityPermissionDragHint": "Перетащить Windoor в Системные настройки",
            "accessibilityPermissionOpenSettings": "Открыть настройки универсального доступа",
            "accessibilityPermissionWaiting": "После разрешения Windoor включится автоматически",
